...
plt.savefig('figures/cylinder_e_and_e_W_S_over_L.png')
plt.show()
plt.close()
...
plt.savefig('figures/cylinder_e_and_e_W_S_over_SA.png')
plt.show()
plt.close()
...
plt.savefig('figures/cylinder_e_and_e_W_S_over_R.png')
plt.show()
plt.close()
...
np.savetxt('cylinder_W_S_over_L.out',Z_L,delimiter=',')
np.savetxt('cylinder_W_S_over_SA.out',Z_SA,delimiter=',')
np.savetxt('cylinder_W_S_over_R.out',Z_R,delimiter=',')
